    ...
    <main>
        <div class="container-fluid">
          ...
          <?php if(session('msg')): ?>
            ...
            <?php endif; ?>
            <?php if(count($produtosAsParticipant) > 0): ?>
          <div class="col-md-10 offset-md-1 dashboard-title-container">
            <h1 style="color: white;">Meus Favoritos</h1>
            <div class="container">
            <?php $__currentLoopData = $produtosAsParticipant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card">
            <div class="imgBx">
                ...
                <ul class="action">
                    <li>
                        ...
                        <form action="/produtos/leave/<?php echo e($produto->id); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Laravel\loja\coffeeShop\resources\views/dashboard.blade.php ENDPATH**/ ?>